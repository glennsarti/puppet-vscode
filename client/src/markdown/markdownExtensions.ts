...
export interface IMarkdownDocumentRenderer {
  addScript(resource: vscode.Uri): void
  addStyle(resource: vscode.Uri): void
}
...
export function loadMarkdownExtensions(
  contentProvider: IMarkdownDocumentRenderer,
